...
ActiveRecord::Schema.define(version: 2019_05_11_194803) do
  ...
  create_table "admin_categorias", id: :serial, force: :cascade do |t|
    t.string "nome"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "admin_super_categoria_id"
    t.index ["admin_super_categoria_id"], name: "index_admin_categorias_on_admin_super_categoria_id"
  end

  create_table "admin_clientes", id: :serial, force: :cascade do |t|
    t.integer "admin_categoria_id"
    t.integer "admin_plano_id"
    t.string "slogan"
    t.string "telefone"
    t.string "endereco"
    t.datetime "created_at", null: false
    ...
    t.string "url"
    t.integer "empresa_status"
    t.string "thumb_url"
    t.integer "enum_img"
    t.index ["admin_categoria_id"], name: "index_admin_clientes_on_admin_categoria_id"
    t.index ["admin_plano_id"], name: "index_admin_clientes_on_admin_plano_id"
    t.index ["empresa"], name: "index_admin_clientes_on_empresa", unique: true
  end

  create_table "admin_definicoes", id: :serial, force: :cascade do |t|
    t.integer "admin_plano_id"
    t.string "desc"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["admin_plano_id"], name: "index_admin_definicoes_on_admin_plano_id"
  end

  create_table "admin_planos", id: :serial, force: :cascade do |t|
    t.string "nome"
    t.decimal "valor"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "admin_recursos", id: :serial, force: :cascade do |t|
    t.string "titulo"
    t.string "desc"
    t.string "img"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "complete_desc"
    t.string "mini_desc"
  end

  create_table "admin_super_categorias", id: :serial, force: :cascade do |t|
    t.string "descricao"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "admin_usuarios", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "administration_level"
    t.integer "admin_cliente_id"
    t.index ["admin_cliente_id"], name: "index_admin_usuarios_on_admin_cliente_id"
  ...
  create_table "area_do_usuario_imagens", id: :serial, force: :cascade do |t|
    t.string "nome"
    t.text "desc"
    t.string "url"
    t.datetime "created_at", null: false
  ...
  create_table "fotos", id: :serial, force: :cascade do |t|
    t.string "image"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "admin_cliente_id"
    t.index ["admin_cliente_id"], name: "index_fotos_on_admin_cliente_id"
  end
  ...
  create_table "imagens", id: :serial, force: :cascade do |t|
    t.string "nome"
    t.text "desc"
    t.string "url"
    t.datetime "created_at", null: false
  ...
  create_table "informativos", id: :serial, force: :cascade do |t|
    t.string "mail"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "principais", id: :serial, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "registros", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["admin_plano_id"], name: "index_registros_on_admin_plano_id"
  end

  create_table "site_thumbnails", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "site_id"
  end
  ...
  add_foreign_key "admin_categorias", "admin_super_categorias"
  add_foreign_key "admin_clientes", "admin_categorias"
  add_foreign_key "admin_clientes", "admin_planos"
  add_foreign_key "admin_definicoes", "admin_planos"
  add_foreign_key "admin_usuarios", "admin_clientes"
  add_foreign_key "fotos", "admin_clientes"
  add_foreign_key "registros", "admin_planos"
end
