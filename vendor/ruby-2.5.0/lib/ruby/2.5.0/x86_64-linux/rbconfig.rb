...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/app/vendor/ruby-2.5.0")
  ...
  CONFIG["configure_args"] = " '--disable-install-doc' '--prefix' '/app/vendor/ruby-2.5.0' '--enable-load-relative' '--enable-shared'"
