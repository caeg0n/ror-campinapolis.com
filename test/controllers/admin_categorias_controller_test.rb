...
class AdminCategoriasControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create admin_categoria" do
    assert_difference('AdminCategoria.count') do
      post admin_categorias_url, params: { admin_categoria: { nome: @admin_categoria.nome } }
    end

    assert_redirected_to admin_categoria_url(AdminCategoria.last)
  end
  ...
  test "should destroy admin_categoria" do
    assert_difference('AdminCategoria.count', -1) do
