...
class FotosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create foto" do
    assert_difference('Foto.count') do
      post fotos_url, params: { foto: { desc: @foto.desc, image: @foto.image, nome: @foto.nome } }
    end
  ...
  test "should update foto" do
    patch foto_url(@foto), params: { foto: { desc: @foto.desc, image: @foto.image, nome: @foto.nome } }
